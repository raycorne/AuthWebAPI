...
namespace MobileAppWebAPI.Migrations
{
    ...
    [Migration("20231111142322_EditingCategory1")]
    partial class EditingCategory1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthWebAPI.Core.Data.User", b =>
                {
            ...
            modelBuilder.Entity("FurnitureRepo.Core.Data.FurnitureCategory", b =>
                {
                    ...
                    b.Property<bool>("IsDisplayedInNavbar")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AuthWebAPI.Core.Data.User", null)
                        .WithMany()
